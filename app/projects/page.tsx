...
import { Eyebrow, Tag, Chip, ImageSlot, PageHeader, CtaBand } from '@/components/ui/primitives';
  ...
  return (
    <main className="page-top" data-screen-label="Projects">
      <PageHeader
        ...
        lede="These are the directions our domains are turning into work. We document outcomes only once they're real — every card here is an honest snapshot, not a press release."
      />
      ...
      <section className="section tint">
        <div className="wrap">
          ...
          <Reveal className="card mt-l" style={{ overflow: 'hidden' }}>
            <ImageSlot label="HERO IMAGE · project [slot]" ratio="cine" />
            <div style={{ padding: 'clamp(28px,4vw,52px)' }}>
              ...
              <div className="grid g-3 mt-l" style={{ gap: 12 }}>
                <ImageSlot label="GALLERY 1" ratio="wide" framed={false} />
                <ImageSlot label="GALLERY 2" ratio="wide" framed={false} />
                <ImageSlot label="GALLERY 3" ratio="wide" framed={false} />
              </div>
            </div>
          </Reveal>
        </div>
